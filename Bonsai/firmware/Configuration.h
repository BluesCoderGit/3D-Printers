...
#define STRING_CONFIG_H_AUTHOR "(Cael Fahnestock, default config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Bonsai 3D is"
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define RIGHT_PROBE_BED_POSITION 89
  #define FRONT_PROBE_BED_POSITION 21
  #define BACK_PROBE_BED_POSITION 109
